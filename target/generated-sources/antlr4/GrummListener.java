...
public interface GrummListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code CallOnObject}
	 * labeled alternative in {@link GrummParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterCallOnObject(@NotNull GrummParser.CallOnObjectContext ctx);
	/**
	 * Exit a parse tree produced by the {@code CallOnObject}
	 * labeled alternative in {@link GrummParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitCallOnObject(@NotNull GrummParser.CallOnObjectContext ctx);
	/**
	 * Enter a parse tree produced by the {@code MapType}
	 * labeled alternative in {@link GrummParser#objectType}.
	 * @param ctx the parse tree
	 */
	void enterMapType(@NotNull GrummParser.MapTypeContext ctx);
	/**
	 * Exit a parse tree produced by the {@code MapType}
	 * labeled alternative in {@link GrummParser#objectType}.
	 * @param ctx the parse tree
	 */
	void exitMapType(@NotNull GrummParser.MapTypeContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterArrayType(@NotNull GrummParser.ArrayTypeContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ArrayType}
	 * labeled alternative in {@link GrummParser#objectType}.
	 * @param ctx the parse tree
	 */
	void exitArrayType(@NotNull GrummParser.ArrayTypeContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterListType(@NotNull GrummParser.ListTypeContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ListType}
	 * labeled alternative in {@link GrummParser#objectType}.
	 * @param ctx the parse tree
	 */
	void exitListType(@NotNull GrummParser.ListTypeContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GrummParser#primitiveType}.
	 * @param ctx the parse tree
	 */
	void enterPrimitiveType(@NotNull GrummParser.PrimitiveTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link GrummParser#primitiveType}.
	 * @param ctx the parse tree
	 */
	void exitPrimitiveType(@NotNull GrummParser.PrimitiveTypeContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterClassType(@NotNull GrummParser.ClassTypeContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ClassType}
	 * labeled alternative in {@link GrummParser#objectType}.
	 * @param ctx the parse tree
	 */
	void exitClassType(@NotNull GrummParser.ClassTypeContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GrummParser#object}.
	 * @param ctx the parse tree
	 */
	void enterObject(@NotNull GrummParser.ObjectContext ctx);
	/**
	 * Exit a parse tree produced by {@link GrummParser#object}.
	 * @param ctx the parse tree
	 */
	void exitObject(@NotNull GrummParser.ObjectContext ctx);
}